...
public class login extends FragmentActivity implements OnMapReadyCallback,
    ...
    List<ItemObjects> staggeredListContent;
...
// A-==A-"+";// A-+
       ...
       //String url=Config.DATA_URL.concat(id1);
        Log.i(TAG,"view"+id1);
    ...
    private void showJSON(String response) {
        ...
        try {
            ...
            for (int i = 0; i < result.length(); i++) {
                ...
                Double lat=Double.parseDouble(address);
                Double lng=Double.parseDouble(vc);
...
//               // list.add(employees);
                ...
                //  LatLng pok = new LatLng(27.7173, 85.3240);
//
//        mMap.addMarker(new MarkerOptions().position(ktm).title("Marker in ktm"));
...
////
////        mMap.addMarker(new MarkerOptions().position(ktm).title("Marker in ktm"));
//        mMap.addMarker(new MarkerOptions().position(ktm).title("Marker in pok"));
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(ktm));
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng point) {
                ...
                if (MarkerPoints.size() >= 2) {
                    ...
                    mMap.animateCamera(CameraUpdateFactory.zoomTo(10000));
                }
    ...
    private void drawPolygon(LatLng startinglocation) {
        ...
        LatLng point3 = new LatLng(startinglocation.latitude + .001,
                startinglocation.longitude + .001);
...
//        }
    ...
    public void onLocationChanged(Location location) {
        ...
        //move map camera
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLng));
        mMap.animateCamera(CameraUpdateFactory.zoomTo(110));
